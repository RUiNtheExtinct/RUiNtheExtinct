      ...
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-[700px] text-muted-foreground">
            My professional journey and the companies I've worked with. Each role has contributed to my growth as a
                  ...
                  <CardHeader>
                    <div className="flex flex-col justify-between gap-2 sm:flex-row sm:items-center">
                      <div>
                        ...
                        <CardDescription className="flex items-center mt-1">{experience.company}</CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent>
