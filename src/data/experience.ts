...
export const experiences: Experience[] = [
  {
    ...
    technologies: ["Next.js", "Python", "AWS", "Terraform", "PostgreSQL", "Docker", "Kubernetes"],
  },
  {
    id: "ml-engineer",
    ...
    technologies: ["Python", "TensorFlow", "PyTorch", "FastAPI", "Docker", "AWS SageMaker", "OpenCV"],
  },
  {
    id: "backend-dev",
    ...
    technologies: ["Java", "Spring Boot", "MongoDB", "Kafka", "Kubernetes", "Redis", "Elasticsearch"],
  },
  {
    id: "frontend-dev",
    ...
    technologies: ["React", "JavaScript", "Redux", "HTML/CSS", "Webpack", "Jest", "Cypress"],
  },
]
