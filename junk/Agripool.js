				...
				<GridItem xs={11} sm={8} md={4}>
					<Card>
						...
						<CardBody align="justify">
							Agripool is a cross-platform native application.
							This is an app that connects the farmers to the
							transporters. The aim was to make sure that a
							transporter’s truck never leaves half filled from
							the village when going to the wholesale market. This
							ensures significant gains for the transporters and
							reduced transportation expenses for the farmers. In
							simple terms, it is uberpool for farmers.
						</CardBody>
					</Card>
				</GridItem>
				<GridItem xs={11} sm={8} md={4}>
					<Card>
						...
						<CardBody align="justify">
							My team used flutter to build this application. I
							worked on multiple pages. Most of the work done here
							was on front-end. I, along with my teammates (
							<a href="https://www.linkedin.com/in/mohil-khare/">
								Mohil
							</a>
							,
							...
							) took part in VCET hackathon with this project. We
							were the 2nd runner-up. Refer the github for more
							info.
							<IconButton>
								<GitHub
									color="primary"
									onClick={() =>
										window.open(
											"https://github.com/Phoenix009/AgriPool"
										)
									}
